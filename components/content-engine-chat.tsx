...
import { Plus, ImageIcon, Mic, Send, Edit, Copy } from 'lucide-react'
...
export default function ChatCard() {
    ...
    return (
        <div className="bg-white rounded-lg p-4 md:p-6 w-full md:w-[589px] shadow-sm h-full flex flex-col">
                ...
                {!hasContent ? (
                    ...
                    <div className="flex-1 flex items-center justify-center">
                        <div className="flex flex-col items-center gap-4 text-center px-4">
                            ...
                            <Button 
                                ...
                                className="inline-flex items-center space-x-2 bg-transparent text-[#31499f] hover:bg-[#f7f9ff] border border-transparent hover:border-[#31499f]" 
                                variant="ghost"
                            >
                    ...
                    <div className="flex-1 flex flex-col space-y-6 overflow-y-auto">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <Button variant="outline" className="flex items-center space-x-2 text-[#31499f] border-[#31499f] hover:bg-[#f7f9ff]">
                                <Plus className="h-4 w-4" />
                        ...
                        <div className="border-t pt-4">
                            <h5 className="text-sm font-medium text-gray-700 mb-3">Generadores de contenido</h5>
