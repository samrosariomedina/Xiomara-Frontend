...
export async function generateMetadata(props: ParamsLike): Promise<Metadata> {
  ...
  const description = 'Manage sources for this campaign';
...
export default async function CampaignFuentesPage(props: ParamsLike) {
  ...
  return (
    <>
      <Navbar />
      <FuentesPage clientId={clientId} campaignId={campaignId} />
    </>
  );
}
