...
export async function generateMetadata(props: ParamsLike): Promise<Metadata> {
  ...
  const description = 'Manage corresponsables for this campaign';
...
export default async function CampaignCorresponsalesPage(props: ParamsLike) {
  ...
  return (
    <>
      <Navbar />
      <CorresponsalesPage clientId={clientId} campaignId={campaignId} />
    </>
  );
}
