...
export async function generateMetadata(props: ParamsLike): Promise<Metadata> {
  ...
  const description = 'Manage knowledge base for this client';
...
export default async function ClientKnowledgePage(props: ParamsLike) {
  ...
  return (
    <>
      <Navbar />
      <KnowledgeBasePage clientId={clientId} />
    </>
  );
}
