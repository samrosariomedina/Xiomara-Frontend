...
import ChatCard from "@/components/content-engine-chat"
import FuentesCard from "@/components/content-engine-fuentes"
import OutputCard from "@/components/content-engine-output"
        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-1 bg-gray-50">
                ...
                <div className="hidden md:block p-6">
                    <div className="mx-auto max-w-[95%] h-[calc(100vh-180px)]">
